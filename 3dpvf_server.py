...
async def get_brain_surfaces(subject: str = Query(None)):
    ...
    position_value_dict = prepare_brain_mri_volume(mri_T1=mri_T1)

    print(f"Loaded brain MRI for subject: {subject}")
...
def prepare_brain_mri_volume(mri_T1: str) -> Dict[str, Any]:
    """
...
def load_subject_source_estimate(subject_name: str, session: str, meta_file: str, file_name: str, timepoint: str):
    ...
    print(f"curent time source signal max: {source_data_time_max}, min: {source_data_time_min}")
